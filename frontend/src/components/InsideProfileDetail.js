          ...
          <div className="InsideProfileDetailMainUp">
            <div className="Left">
              <div className="StudentAvatar">
                ...
                <div
                  ...
                  onClick={this.ChangingAva.bind(this)}
                >
                  <div className="StudentProfileLayerText">Change Avatar</div>
                </div>
              </div>
            </div>
            ...
            {isChangingAva && (
              <div className="AvatarRight">
                ...
                {ConfirmBtn && (
                  <span className="ChangeCss" onClick={this.Change.bind(this)}>
                    Change
                  </span>
                )}
              </div>
